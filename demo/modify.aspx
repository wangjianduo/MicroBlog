                ...
                <div class="card col-sm-6 m-auto" style="font-weight: bolder; background-color: #000000;">
                    <div class="card-body">
                        <div class="text-center">
                            <h3 class="badge text-center" style="color: #000000; background-color: #FF9900; font-size: 25px;">修改信息</h3>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="TextBox2" class="form-control" placeholder="用户名（必填）" type="text" runat="server" ReadOnly="True"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label class="control-label" style="color: #FFFFFF">密码</label>
                            <asp:TextBox ID="TextBox3" class="form-control" placeholder="密码（必填）" runat="server"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label class="control-label" style="color: #FFFFFF">重复密码</label>
                            <asp:TextBox ID="TextBox5" class="form-control" placeholder="重复密码（必填）" runat="server"></asp:TextBox>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-6">
                                <asp:Button ID="Button1" class="btn btn-block" Style="margin-bottom: 15px" runat="server" Text="确认修改" OnClick="Button1_Click" Visible="True" BorderColor="#FF9900" BackColor="#FF9900" />
                            </div>
                        </div>
                    </div>
                </div>
