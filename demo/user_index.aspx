<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_index.aspx.cs" Inherits="user_index" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="row card mb-3" style="background-color: #000000;">
                ...
                <div class="card-body" style="background-color: #000000">
                    ...
                    <div class="col text-center container">
                        <asp:TextBox ID="TextBox1" runat="server" Style="color: #FFFFFF; text-align: center; vertical-align: middle" Width="100%" BorderStyle="Inset" BackColor="#333333" ReadOnly="True"></asp:TextBox>
                    </div>
                    <p></p>
                    <div class="text-center">
                        <asp:Button ID="Button2" Style="font-weight:bolder" CssClass="btn btn-warning" runat="server" Text="关注" OnClick="Button2_Click" Width="30%" />
                    </div>
                </div>
            </div>
                ...
                <div class="row card mb-3" style="background-color: #000000">
                    ...
                    <div class="card-body container " style="background-color: #000000">
                        <div class="container text-center" style="color: #FFFFFF; font-size: 30px; font-weight: bolder;">
                            <asp:Label ID="Label_nothing" runat="server" Text="他还没有发留言！" Visible="false"></asp:Label>
                        </div>
                        <br />
