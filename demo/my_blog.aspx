<%@ Page Language="C#" AutoEventWireup="true" CodeFile="my_blog.aspx.cs" Inherits="my_blog" MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="container">
            <div class="row card mb-3" style="background-color: #000000;">
                ...
                <h5 class="card-header text-center " style="background-color: #F7971D; color: #000000;">
                    <b>
                        <asp:Label ID="Label2" runat="server" Text="我的主页"></asp:Label>
                    </b>
                </h5>
                <div class="card-body" style="background-color: #000000">
                    <div class="text-center">
                        <h5 style="color: #FFFFFF; font-weight: bolder;">个人签名</h5>
                    </div>
                    <div class="col text-center container">
                        <asp:TextBox ID="TextBox1" runat="server" Style="color: #FFFFFF; height:50px; text-align: center; vertical-align: middle" Width="100%" BorderStyle="Inset" BackColor="#333333" ReadOnly="True"></asp:TextBox>
                    </div>
                    <p></p>
                    <div class="text-center">
                        <asp:Button ID="Button2" Style="font-weight: bolder" CssClass="btn btn-warning" runat="server" Text="我的历史评论" OnClick="Button2_Click" Width="30%" />
                    </div>
                </div>
            </div>
            ...
            <div class="row card mb-3" style="background-color: #000000;">
                <div class="card-header" style="background-color: #F7971D">
                    <h5 class="text-center" style="font-weight: bolder; background-color: #F7971D; color: #000000;">发微博</h5>
                </div>
                <div class="card-body" style="background-color: #000000">
                    <div class="col text-center container">
                ...
                <div class="row card mb-3" style="background-color: #000000">
                    ...
                    <div class="card-body container " style="background-color: #000000">
                        <div class="container text-center" style="color: #FFFFFF; font-size: 30px; font-weight: bolder;">
                            <asp:Label ID="Label_nothing" runat="server" Text="您还没有发微博！" Visible="false" ></asp:Label>
                        </div>
                        <br />
                                    ...
                                    <div class="card-header container" style="background: #333333">
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="">
                                                ...
                                                <asp:Button ID="Button_edit" class=" btn btn-sm btn-outline-warning " runat="server" Text="编辑" CommandName="edit" CommandArgument='<%# Eval("id_blog")%>'/>
                                                <asp:Button ID="Button_delete" class=" btn btn-sm btn-outline-warning "  runat="server" Text="删除" CommandName="delete_blog" CommandArgument='<%# Eval("id_blog")%>' />
                                            </div>
