<%@ Page Language="C#" AutoEventWireup="true" CodeFile="comment_history.aspx.cs" Inherits="comment_edit" %>
                                    ...
                                    <div class="card-header container" style="background: #333333">
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="">
                                                ...
                                                <asp:Button ID="Button_edit" class=" btn btn-sm btn-outline-warning " runat="server" Text="编辑" CommandName="edit" CommandArgument='<%# Eval("id_comment")%>' />
                                                <asp:Button ID="Button_delete" class=" btn btn-sm btn-outline-warning " runat="server" Text="删除" CommandName="delete_blog" CommandArgument='<%# Eval("id_comment")%>' />
                                            </div>
