                ...
                <div class="row card mb-3" style="background-color: #000000">
                    ...
                    <div class="card-body container " style="background-color: #000000">
                        <div class="container text-center" style="color: #FFFFFF; font-size: 30px; font-weight: bolder;">
                            <asp:Label ID="Label_nothing" runat="server" Text="您还没有关注的人！" Visible="false"></asp:Label>
                        </div>
                        <br />
                                ...
                                <div class="card mb-3" style="background-color: #333333">
                                    ...
                                    <div class="card-header container" style="background: #333333">
                                        <div class="row justify-content-between">
                                            <div class="col-6">
                                                <b class="" style="font-weight: bolder; font-family: 宋体; font-size: 20px; color: #FFFFFF;"><%# Eval("friend_name")%></b>
                                                
                                            </div>
                                            <div class="">
                                                <asp:Button ID="Button_follow" Style="font-weight: bolder" CssClass="btn btn-sm btn-outline-warning" runat="server" Text="查看主页" CommandName="user_index" CommandArgument='<%# Eval("friend_id")%>' />
                                            </div>
                                    ...
                                    <div class="card-body" style="background-color: #666666">
                                        ...
                                        <div class="col container  text-center">
                                            ...
                                            <p class="card-text" style="color: #FFFFFF"><%# Eval("friend_introduction")%></p>
                                    ...
                                    <div class="card-footer text-muted" style="background: #333333">
                                        <div class="container">
                                            <div class="text-center">
                                                <asp:Button ID="Button2" Style="font-weight:bolder" CssClass="btn btn-sm btn-outline-warning" runat="server" Text="取消关注" Width="30%" CommandName="delete_friend" CommandArgument='<%# Eval("friend_id")%>'/>
