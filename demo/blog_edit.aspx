<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blog_edit.aspx.cs" Inherits="blog_edit" %>
        ...
        <div class="container">
            <div class="row card mb-3" style="background-color: #000000;">
                <div class="card-header" style="background-color: #F7971D">
                    <h5 class="text-center" style="font-weight: bolder; background-color: #F7971D; color: #000000;">修改微博</h5>
                </div>
